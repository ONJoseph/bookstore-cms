...
- Clone the repository using `git clone https://github.com/ONJoseph/bookstore-cms.git`
- Change directory into the project folder: `cd bookstore-cms`
- Run `npm install`
- Run `npm start`
...
Feel free to check the [issues page](https://github.com/ONJoseph/bookstore-cms/issues).
...
This project is [MIT](https://github.com/ONJoseph/bookstore-cms/blob/Initialize-project/LICENCE) licensed.
